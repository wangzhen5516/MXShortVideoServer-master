...
public class RealTimeTagPoolRecallMirror extends BaseRecall<BaseDataCollection>{
    private String HUMAN_PREFIX = "human_tag_in_";
    private String AUDIO_PREFIX = "audio_";
    int TAG_NUM = 1;
    private static Logger logger = LogManager.getLogger(RealTimeTagPoolRecallMirror.class);
