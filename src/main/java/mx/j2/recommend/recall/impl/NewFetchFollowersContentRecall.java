...
public class NewFetchFollowersContentRecall extends BaseRecall<FeedDataCollection> {
     ...
     * 构造函数
     */
    public NewFetchFollowersContentRecall() {
        init();
    }
...
//            Collections.shuffle(mergedList);
        ...
        dc.followGuaranteeList.addAll(mergedList);
    ...
    public static void main(String[]args){
        NewFetchFollowersContentRecall recall = new NewFetchFollowersContentRecall();
