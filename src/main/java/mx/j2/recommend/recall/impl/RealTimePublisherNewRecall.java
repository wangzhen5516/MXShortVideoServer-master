...
@Deprecated
public class RealTimePublisherNewRecall extends BaseRecall<BaseDataCollection> {
    ...
    public RealTimePublisherNewRecall() {
    ...
    public void recall(BaseDataCollection dc) {
        ...
        if (MXStringUtils.isNotEmpty(userId)) {
            ...
            if (MXJudgeUtils.isNotEmpty(pubIds)) {
                ...
                } else if (pubIds.size() > 6 && pubIds.size() <= 8) {
                    dc.ratioForRealTimeMixer = pubIds.size() / 2;
                } else if (pubIds.size() > 8) {
                    dc.ratioForRealTimeMixer = 4;
                }
