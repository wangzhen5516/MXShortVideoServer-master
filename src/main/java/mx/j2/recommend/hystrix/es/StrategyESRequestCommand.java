...
public class StrategyESRequestCommand extends HystrixCommand<String> {
    private String request;
    private String content;
    private RestClient restClient;

    private StrategyESRequestCommand() {
        super(HystrixUtil.strategyEsSetter);
    }

    public StrategyESRequestCommand(RestClient restClient, String request, String content) {
        this();
