...
public class VideoESRequestCommand extends HystrixCommand<String> {
    private String request;
    private String content;
    private RestClient restClient;

    private VideoESRequestCommand() {
        super(HystrixUtil.videoEsSetter);
    }

    public VideoESRequestCommand(RestClient restClient, String request, String content) {
        this();
