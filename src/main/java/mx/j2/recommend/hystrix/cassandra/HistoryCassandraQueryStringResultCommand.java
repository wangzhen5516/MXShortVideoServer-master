 ...
 */
public class HistoryCassandraQueryStringResultCommand extends HystrixCommand<String> {

    private String query;
    private String rowName;
    private CqlSession session;

    private HistoryCassandraQueryStringResultCommand() {
        super(HystrixUtil.historyCassandraSetter);
    }

    public HistoryCassandraQueryStringResultCommand(CqlSession session, String query, String rowName) {
        this();
