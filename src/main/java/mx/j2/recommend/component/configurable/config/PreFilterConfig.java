 ...
 * @version 1.0
 * @date 2021/5/12 下午8:27
 * @description
 */
public final class PreFilterConfig<T, D> extends BaseStreamComponentConfig<D> {
    public static final String KEY_PASS = "pass";// 放行项（不过滤）
    public static final String KEY_TEST = "test";// 检测项

    public PreFilterConfig(Map<String, ConfigValuePair> confMap) throws Exception {
        super(confMap);
    }
